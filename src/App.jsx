...
const featureGroups = [
  {
    ...
    points: [
      ...
      "Voice handoff для сценариев со звонками",
    ],
  },
  {
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Да. TrustOne собирает и оценивает кандидатов из CSV, web search и URL scan, объясняет почему они подходят, и подсказывает лучший заход. Это контур приоритизации и warm-intro, а не mass spam automation.",
  },
  {
    question: "Работаете ли вы со звонками?",
    answer:
      "Да. TrustOne поддерживает voice-контур: транскрипт попадает в диалог, а при низкой уверенности кейс автоматически передается менеджеру. Для глубоких интеграций с конкретной телефонией подключаемся отдельно.",
  },
  {
      ...
      <main className="shell">
        ...
        <section className="section featureSection reveal">
          ...
          <p className="featureNote">
            ...
            поддерживать звонковые сценарии.
          </p>
        </section>
        ...
        <section className="section trustSection reveal">
          ...
          <p className="trustExtra">
            Дополнительно: поиск новых клиентов через scored opportunity feed и поддержка звонков через voice handoff.
          </p>
        </section>
